...
#				print writeTaint,line
				...
				if rightTaint == 't1': # assiging zero 
					if blockNumber == '197' or blockNumber == 197:
						print blockNumber, "ZERO: rightTaint", rightTaint, "prevReadTaint" , prevReadTaint , line
					...
					if blockContents[int(blockNumber)][int(offset)] == 'U':
						...
						if blockNumber == '197' or blockNumber == 197:
							print blockNumber, "AAAA : rightTaint", rightTaint, "prevReadTaint" , prevReadTaint , line
...
#		blockTaintDict[]
	...
	for blockNumber,TaintList in blockTaintDict.items():
		...
		for taint in TaintList:
			...
			#	print blockNumber,blockContents[blockNumber]
