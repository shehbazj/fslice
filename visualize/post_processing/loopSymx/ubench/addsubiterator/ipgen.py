...
if __name__ == "__main__":
    ...
    for postCondition in postConditionValues:
        ...
        for i in range(1, int(arraySize) + 1):
            ...
            f.write("    negcounter"+ str(i) +" =Int('negcounter"+ str(i) +"')\n")
            f.write("    op"+ str(i) +" =Int('op"+ str(i) +"')\n")
            f.write("    s.add(counter"+ str(i) +" >= 0)\n")
            f.write("    s.add(negcounter"+ str(i) +" >= 0)\n")
            f.write("    s.add(counter"+ str(i) +" <= 1)\n")
            f.write("    s.add(negcounter"+ str(i) +" <= 1)\n")

        f.write("    s.add(")
        for i in range(1, int(arraySize)):
            f.write("    counter" + str(i) + " * " + str(i) + " + ")
            f.write("    negcounter" + str(i) + " * " + str(i) + " + ")
        f.write("    counter" + arraySize + " * " + arraySize + " + negcounter" + arraySize + " * " + arraySize + " == " + postCondition + ")\n")
