...
s.add((count1 * 1) + (count2 * 2) + (count3 * 3) + (count4 * 4) + (count5 * 5) + (count6 * 6) + (count7 * 7) + (count8 * 8) + (count9 * 9) + (count10 * 10) + (count11 * 11) + (count12 * 12) + (count13 * 13) + (count14 * 14) + (count15 * 15) + (count16 * 16) + (count17 * 17) + (count18 * 18) + (count19 * 19) + (count20 * 20) + (count21 * 21) + (count22 * 22) + (count23 * 23) + (count24 * 24) + (count25 * 25) + (count26 * 26) + (count27 * 27) + (count28 * 28) + (count29 * 29) + (count30 * 30) + (count31 * 31) + (count32 * 32) + (count33 * 33) + (count34 * 34) + (count35 * 35) + (count36 * 36) + (count37 * 37) + (count38 * 38) + (count39 * 39) + (count40 * 40) + (count41 * 41) + (count42 * 42) + (count43 * 43) + (count44 * 44) + (count45 * 45) + (count46 * 46) + (count47 * 47) + (count48 * 48) + (count49 * 49) + (count50 * 50)  == 75)
x=s.check()
if(x == z3.sat):
        m = s.model()
        print m
